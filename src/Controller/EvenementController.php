...
//            $evenement->setImage($fileName);
    ...
    public function reserver(Request $request, ReservationEvenementRepository $reservationEvenementRepository,EvenementRepository $evenementRepository): Response
    {
        $id = $request->get("id");
